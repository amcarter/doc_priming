...
setwd("/Users/niko/Dropbox/leachate_linder/lexperiment2_7_12_22")
#setwd("/your path")
###########
## IMPORT
###########
...
meta <- read.table("lexperiment2_7_12_2022.txt", sep=",",header=T)
...
## Plot
subdat_melt <- melt(subdat[,4:10], id.vars=c("DATETIME","samplenum"))
...
####Niko, I do not think you need the below
