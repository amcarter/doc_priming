...
alkalinity <- read_csv("~/Dropbox/leachate_linder/alkalinity.csv")
plot(alkalinity$date, experiment1_summary2$delCO2_norm, xlab="Time Interval",ylab="normalized delCO2")

sp <- ggplot(alkalinity, aes(x = date, y = alkalinity (mg/L CaC03), col = treatment))+
  geom_point()
sp
